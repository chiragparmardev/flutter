...
class FirstBottom extends StatelessWidget {
  const FirstBottom({
    super.key
  });
        ...
        Column(
          ...
          children: [
            Padding(
              ...
              child: Row(
                ...
                children: [
                  ...
                  const CustomPageLabelText(title: 'Text', pageno: '1'),
            ...
            Consumer<TypeDataProvider>(builder: (context, value, child) {
              ...
              return Column(
                children: [
                  for (var type in value.typeDataList)
                    CheckboxListTile(
                      controlAffinity: ListTileControlAffinity.leading,
                      value: type.isSelected,
                      onChanged: (v) {
                        int index = value.typeDataList.indexOf(type);
                        value.updateTypeData(index, v ?? false);
                      },
